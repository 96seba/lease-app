...
export default function EditarPropiedad() {
    ...
    return (
        <div className="w-screen h-[91.5vh] p-6 flex justify-between items-center">
            <div className="flex rounded flex-col justify-center items-start p-6 w-5/12 h-full shadow-md bg-gray-200">
                <p className="flex my-4 text-xl">
                    Datos de la propiedad
                </p>
                <div className="mb-3 w-full bg-blue-200">
                    <input className="shadow appearance-none border h-[90%] rounded w-full py-2 px-3 text-grey-darker" id="username" type="number"
            ...
            <div className="flex   justify-between flex-col items-center w-6/12 h-full ">
                <div className="flex flex-col p-6 rounded w-full h-[45%] justify-center items-center shadow-md bg-gray-200">
                    <p>Contrato</p>
                    <div className="mb-3 w-full">
                ...
                <div className="flex flex-col rounded w-full h-[45%] justify-center items-center shadow-md bg-gray-200">
