        ...
        <div className=" bg-gray-100 w-screen h-[91.5vh] p-6 flex flex-col  justify-center items-center">
            {
                error === true ?
                    ...
                    <div id="toast-danger" class="flex sticky items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
