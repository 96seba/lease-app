...
export default function AgregarPropiedad() {
    ...
    return (
        <div className="w-[100vw] sm:w-[100vw] md:w-[80vw] lg:w-[80vw] xl:w-[65vw] h-[120.5vh] p-6 bg-gray-200 flex justify-between items-center">

            <div className='w-1/2 h-full flex flex-col justify-start items-center bg-teal-200'>
                ...
                <div className="mb-1 w-[90%] flex flex-col justify-center items-start">
                    <p>Direccion</p>
                    <input className="appearance-none border h-[90%] rounded w-[95%] py-2 px-3 text-grey-darker" id="username" type="text"
                ...
                <div className="mb-1 w-[90%] flex justify-around flex-row">
                    <div className='w-1/2 h-[10vh] flex flex-col justify-center items-start'>
                        <p>Dormitorios</p>
                        <input className="appearance-none border h-[40%] rounded w-[90%] py-2 px-3 text-grey-darker" id="username" type="Number"
                            placeholder="Dormitorios" />
                    </div>
                    <div className='w-1/2 h-[10vh] flex flex-col justify-center items-start'>
                        <p>Baños</p>
                ...
                {/* <div className="mb-3 w-[80%]">
                    <input className=" appearance-none border h-[90%] rounded w-full py-2 px-3 text-grey-darker" id="username" type="text"
                        placeholder="Dormitorios" />
                </div>
                {foto === "" ?
                    ...
                    : <div className='flex rounded justify-center flex-col items-center h-[40%] w-full bg-gray-200'>
                        <p>{foto}</p>
                        <button
                            onClick={() => {
                                setFoto("")
            ...
            <div className='w-1/2 h-full bg-sky-300'>
