    ...
    return (
        <div className='bg-gray-100'>
            <button onClick={() => {
                ...
                <button type="button" className="text-white bg-[#023E8A] hover:bg-[#023E8A] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-[#023E8A] dark:hover:bg-[#023E8A] dark:focus:ring-blue-800">
